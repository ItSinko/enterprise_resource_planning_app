...
<template>
    <div class="modal fade modalterlaksana" data-backdrop="static" data-keyboard="false" tabindex="-1"
                ...
                <div class="modal-body">
                        ...
                        <div class="col-sm-10">
                            <div class="d-flex flex-row-reverse bd-highlight">
                                <div class="p-2 bd-highlight">
                                    <button class="btn btn-primary" @click="tambahpic">
                                        Tambah
                                    </button>
                                </div>
                            </div>
                            <div v-for="(notulen, idx) in form.notulensi" class="row mb-1">
                                <div class="col-sm-4">
                                    <vue-select v-model="notulen.pic" :options="karyawan" label="nama"
                                        :reduce="(karyawan) => karyawan.id" placeholder="penanggung jawab" />
                                </div>
                                <div class="col-sm-6">
                                    <textarea class="form-control" v-model="notulen.isi"
                                        placeholder="Isi Notulensi"></textarea>
                                </div>
                                <div class="col-sm-2">
                                    <button class="btn btn-danger" @click="form.notulensi.splice(idx, 1)">
                                        x
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="d-flex flex-row-reverse bd-highlight">
                                <div class="p-2 bd-highlight">
                                    <button class="btn btn-primary" @click="tambahhasil">
                                        Tambah
                                    </button>
                                </div>
                            </div>
                            <div v-for="(hasil, idx) in form.hasil" class="row">
                                ...
                                <div class="col-2">
                                    <button class="btn btn-danger" @click="form.hasil.splice(idx, 1)">
                                        x
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-10">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="pills-foto-tab" data-toggle="pill"
                                        data-target="#pills-foto" type="button" role="tab" aria-controls="pills-foto"
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-foto" role="tabpanel"
                                    ...
                                    <dokumentasi :file="form.dokumentasi.foto" format="image" />
                                </div>
                                <div class="tab-pane fade" id="pills-video" role="tabpanel"
                                    aria-labelledby="pills-video-tab">
                                    <dokumentasi :file="form.dokumentasi.video" format="video" />
                                </div>
                                <div class="tab-pane fade" id="pills-rekaman" role="tabpanel"
                                    aria-labelledby="pills-rekaman-tab">
                                    <dokumentasi :file="form.dokumentasi.rekaman" format="audio" />
                                </div>
                                <div class="tab-pane fade" id="pills-lainnya" role="tabpanel"
