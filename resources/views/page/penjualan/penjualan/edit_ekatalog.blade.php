                                                            ...
                                                            <div class="tab-pane fade show active" id="pills-penjualan"
                                                                ...
                                                                <div class="card removeshadow">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="form-group row  @if ($e->status != 'draft') hide @endif"
                                                                            id="isi_produk_input">
                                                                            <label for=""
                                                                                class="col-form-label col-lg-5 col-md-12 labelket"></label>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        @if (isset($e->pesanan))
                                                                            @if (isset($e->pesanan->detailpesanandsb))
                                                                                @foreach ($e->pesanan->detailpesanandsb as $g)
                                                                                    <tr>
                                                                                        <td>{{ $g->iteration }}</td>
                                                                                        <td>
                                                                                            <div
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    style="width:100%;">
                                                                                                    <option
                                                                                                        value="{{ $g->penjualan_produk_id }}"
                                                                                                        selected>
                                                                                                        {{ $g->penjualanproduk->nama }}
                                                                                                    </option>
                                                                                                </select>
                                                                                            </div>
                                                                                            <div class="detail_produk"
                                                                                                id="detail_produk{{ $loop->iteration }}">
                                                                                                <fieldset>
                                                                                                    <legend><b>Detail
                                                                                                            Produk</b>
                                                                                                    </legend>
                                                                                                    <?php $variasi = 0; ?>
                                                                                                    @foreach ($g->DetailPesananProdukDsb as $h)
                                                                                                        <div>
                                                                                                            <div
                                                                                                                class="card-body blue-bg">
                                                                                                                <h6>{{ $h->GudangBarangJadi->Produk->nama }}
                                                                                                                </h6>
                                                                                                                <select
                                                                                                                    ...
                                                                                                                    data-id="{{ $variasi }}">
                                                                                                                    <option
                                                                                                                        value="{{ $h->GudangBarangJadi->id }}">
                                                                                                                        @if (!empty($h->GudangBarangJadi->nama))
                                                                                                                            {{ $h->GudangBarangJadi->nama }}
                                                                                                                        @else
                                                                                                                            {{ $h->GudangBarangJadi->Produk->nama }}
                                                                                                                        @endif
                                                                                                                    </option>
                                                                                                                </select>
                                                                                                                <span
                                                                                        ...
                                                                                        <td>
                                                                                            <div
                                                                                                ...
                                                                                                <input type="checkbox"
                                                                                                    class="form-check-input stok_dist"
                                                                                                    id="stok_dist"
                                                                                                    name="stok_dist[]"
                                                                                                    value="1" checked>
                                                                                            </div>
                                                                                        ...
                                                                                        <td>
                                                                                            <div
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    value="{{ number_format($g->ongkir, 0, ',', '.') }}" />
                                                                                            </div>
                                                                                        </td>
                                                                                        <td>
                                                                                            <div
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    style="width:100%;"
                                                                                                    value="{{ number_format($g->harga * $g->jumlah + $g->ongkir, 0, ',', '.') }}"
